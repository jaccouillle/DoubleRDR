...
\end{algorithm}    
      ...
      Voici le premier algorithme correspondant aux deux premiers procédés de la partie $5.2.3$ (avec $0$ ajouté au tableau $\dbarre$),
...
\end{algorithm}
 ...
 \begin{algorithmic}
  \REQUIRE une puissance $pow$, l'ensemble $\dbarre$ avec $Wn$ (borne).
  \ENSURE $DoubleDmax$.
